from insurancepremium.entity.config_entity import DataIngestionConfig, DataTransformationConfig, DataValidationConfig,   \
ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig,TrainingPipelineConfig
from insurancepremium.util.util import read_yaml_file
...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            transformed_train_dir=os.path.join(
                    data_transformation_artifact_dir,
                    data_transformation_config_info[DATA_TRANSFORMATION_TRANSFORMATION_DIR_NAME_KEY],
    ...
    def get_model_evaluation_config(self) ->ModelEvaluationConfig:
        try:
            ...
            modek_evaluation_artifact_dir = os.path.join(self.training_pipeline_config.artifact_dir,
                                        MODEL_EVALUATION_ARTIFACT_DIR, )

            model_evaluation_file_path = os.path.join(modek_evaluation_artifact_dir,
