...
from insurancepremium.util.util import load_object
import pandas as pd
...
class InsurancePremiumData:
    ...
    def get_premium_input_data_frame(self):
        try:
            insurancepremium_input_dict = self.get_premium_data_as_dict()
            return pd.DataFrame(insurancepremium_input_dict)
